...
companies_feature = pd.read_csv("spolied_companies_extra_column_2.csv", sep = ",").dropna()
transport_feature = pd.read_csv("spoiled_transport_extra_column_2.csv", sep = ",").dropna()
